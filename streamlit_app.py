...
<style>
    ...
    [data-testid="stColumn"] { min-height: 200px !important; }
    ...
    .brain-text { font-family: 'Fredoka One', cursive; font-size: 22px; text-shadow: 2px 2px #023e8a; }
    ...
    .card-label { font-size: 12px; text-transform: uppercase; margin-top: 10px; opacity: 0.8; }
