...
# 2. CSS για Σταθερότητα, Μείωση Κενών και Εμφάνιση Φινάλε
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Fredoka+One&display=swap');

    /* Μείωση κενού στην κορυφή και ανάμεσα στα στοιχεία */
    ...
    /* ΤΟ ΜΕΓΑΛΟ ΓΑΛΑΖΙΟ ΠΛΑΙΣΙΟ ΤΕΛΟΥΣ */
    .finish-box {
